...
;(function(){
	qnml.addLanguage({
		...
		style:'.hh-code{        font-family: Monaco, "Liberation Mono", Courier, monospace;        font-size: 12px;        line-height: 18px;        color: #333333;        margin-left:40px;        position:relative;        padding-left:10px;        word-wrap:break-word;        text-decoration:none;        border-left: 1px solid #D4D4D4;    }        .hh-comment{        color: #999999;    }    .hh-pound{        color: #999988;    }    .hh-tag{        color:#000080;    }    .hh-attr{        color:#008080;    }    .hh-string{        color: #d14;    }    .hh-regexp{        color: #009926;    }    .hh-keyword{        color: #0086B3;    }    .hh-library{        color: #0086B3;    }    .hh-number{        color: #009999;    }    .hh-line{        position:absolute;        left:-39px;        display: inline-block;        width: 30px;        color: #aaa;        text-align: right;        padding-right: 8px;        border-right: 1px solid #D4D4D4;        -webkit-user-select:none;    }'
	});
})();
;(function(){
	qnml.addLanguage({
...
(function(){
	...
	var block = "    ";
	var isInit = false;
	var style = '.ce-wrap{border: 1px solid #ccc;position: relative;}.ce-dis,.ce-ipt{line-height: 18px;white-space: pre;height: 80px;font-size: 12px;padding: 0px;margin: 0px;word-wrap:break-word;border: 0px;font-family: Monaco, "Liberation Mono", Courier, monospace;}.ce-dis{z-index: 999;pointer-events:none;position: absolute;top:0px;left: 0px;text-shadow:0 0 5px #fff;}.ce-ipt{outline: none;resize:none;background-color: transparent; color: #999;overflow: hidden;color: #ccc;padding-left: 50px;}';
	window.nce = {
